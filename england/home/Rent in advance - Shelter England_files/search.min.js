...
$(document).ready(function(){
    jQuery("#js-searchField input[type=search]").fbcompletion({
        'enabled'    : 'enabled',
        'collection' : 'shelter-england',
        'program'    : 'https://search06.funnelback.co.uk/s/suggest.json',
        'format'     : 'extended',
        'alpha'      : '.5',
        'show'       : '10',
        'sort'       : '0',
